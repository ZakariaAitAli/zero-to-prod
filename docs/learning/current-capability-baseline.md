...
| --- | --- | --- |
| Backup and restore of application data | L0 | Persistent application state now exists, but no backup/restore mechanism or recovery experiment has been implemented. |
